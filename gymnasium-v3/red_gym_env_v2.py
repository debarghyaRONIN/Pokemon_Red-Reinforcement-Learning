...
class RedGymEnv(Env):
    ...
    #def update_evolution_reward(self):
    # Check evolution flags
        #evolution_successful = int(self.read_bit(0xDD121-1, 6))
        #evolution_pic_change = int(self.read_bit(0xD7EE4, 2))
        #evolution_cancelled = int(self.read_bit(0xD7F0D-5, 1))#"0xDD121-1": "wEvolutionOccurred"
    
    # Calculate current step reward
        #current_reward = (evolution_successful * 5.0) + (evolution_cancelled * -2.5) 
    
    # Track cumulative stats if needed
       # if evolution_successful:
            #self.evolution_count += 1
        #if evolution_cancelled:
            #self.evolution_cancelled_count += 1
    
    # Add to total evolution reward
        #self.total_evolution_reward += current_reward
    ...
    def append_agent_stats(self, action):
        ...
        self.agent_stats.append(
            ...
            #"evolve": self.evolution_count,
            #"evolve_cancel": self.evolution_cancelled_count
        }
    )
    ...
    # Track evolution events using the update method
        #evolution_reward = self.update_evolution_reward()
       ...
       # "evolve": self.reward_scale * self.total_evolution_reward * 0.02  # Using cumulative evolution reward
        }
