...
if __name__ == "__main__":
    ...
    if exists(file_name + ".zip"):
        ...
        model = PPO("MultiInputPolicy", env, verbose=1, n_steps=train_steps_batch, batch_size=1024, n_epochs=3, gamma=0.999, ent_coef=0.02, tensorboard_log=sess_path)
